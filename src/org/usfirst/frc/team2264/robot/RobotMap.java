...
public class RobotMap {
	...
	final static int INTAKE_MOTOR_PORT_FOUR = 10;
	final static int INTAKE_MOTOR_PORT_THREE = 9;
	final static int INTAKE_MOTOR_PORT_TWO = 8;
	final static int INTAKE_MOTOR_PORT_ONE = 7;
	final static int WINCH_MOTOR_PORT = 6;
	...
	final static double AUTO_MOTOR_ADJUST_ONE = 0.81;
